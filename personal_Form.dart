...
class _PersonalFormState extends State<PersonalForm> {
  ...
  void _showSubmittedData() {
    ...
    Text('Date: ${_selectedDate == null ? 'Not selected' : _selectedDate!.toLocal().toString()}');
                ...
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (context) => Second(
                      ...
                      address: address,
                      personalId: personalId, Fullname: '', personalID: '',
                    ),
                  ),
                );
              },
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildTextField("Enter Full Name", _fullNameController), // Perbaikan teks hint
              ...
              children: [
                Expanded(
                  child: _buildTextField(
                      "Enter Phone Number", _phoneNumberController), // Perbaikan teks hint
                ),
                Expanded(
            ...
            _buildTextField("Enter Personal ID", _personalIdController), // Perbaikan teks hint
            _buildLabelLeftAligned("Address"),
            _buildTextField("Enter your Address", _addressController), // Perbaikan teks hint
...
Widget _buildDateTextField(){
  return ListTile(
    ...
    trailing: Icon(Icons.calendar_today), // Ganti dengan ikon kalender yang sesuai
    onTap: () async {
